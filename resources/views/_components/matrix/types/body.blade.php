...
@component('_components.matrix.base')
  <div class="container container--small rte">
    ...
    <p>Labore JavaScript elit incididunt jQuery Esign jQuery PHP7 magna. Eiusmod SEA SEO adwords website, dolore consectetur sit adwords lorem attractive website. Elit ut Ghent Stropkaai development et graphic design. Magna dolore sed aliqua et consectetur sed. <em>Adwords sit ecommerce dolor sed PHP7</em> business plan website SEA.</p>
