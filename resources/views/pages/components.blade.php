...
{% set description = '' %}
{% set menuitem = 'components' %}
{# Only add bodyclass if necessary #}
{% set bodyclass = '' %}
{% set datapage = 'components' %}
...
<div class="container">
  ...
  <p>Almost every developer's favorite <em>molecule</em> is C<sub>8</sub>H<sub>10</sub>N<sub>4</sub>O<sub>2</sub>, also
    known as "caffeine".</p>
      ...
      <form id="form-contact" action="#" method="post" class="validate">
        ...
        <div class="input-group">
          <div class="checkbox">
            ...
            <label for="privacy">I agree my data will be processed in accordance with the privacy policy. <span class="required">*</span></label>
          </div>
        </div>
